...
export class AppComponent {
  ...
  //     console.group(
  //       `%c👨‍💻 Hi, I'm Stanislaw Marcin W. and Thanks for checking out my Portfolio!`,
  //       styles
  //     );
  //     console.log(
  //       "%c📺 YouTube - https://www.YouTube.com/CodingTutorials360",
  //       styles
  //     );
  ...
  //     console.log(
  //       "%c📝 LinkedIn - https://www.linkedin.com/in/dylan310/",
  //       styles
  //     );
